...
if(isset($_POST['creategame'])) {
    ...
    $title = strip_tags($_POST['gametitle']);
    $title = stripslashes($title); 

    $img = strip_tags($_POST['imagelink']);
    ...
    $link->query("INSERT INTO games (title, image, genre, rating) VALUES ('$title', '$img','$genre', $rating)");
}
...
if(isset($_POST['submit'])) {
  ...
  foreach ( $games as $item ) { 
    ...
    echo "<li>";
    echo "<a href=\"gamepage.php?id=".$games[$index]['id']."\" class='ex4'>";
...
<html lang="en">
  <head>
    ...
    <title>Rynek Catalogue [ADMIN]</title>
  ...
  <body>
    ...
    <form action="gamescatalogueadmin.php" method="post">
      <ul style="float: left;">
        <li>
      <input
        name="search"
    ...
    <div>
      <div>
        ...
        <?php foreach( $numgames as $item ) { ?>
          ...
          <li>
          <?php echo "<a href=\"gamepage.php?id=".$item."\" class='ex4'>"?>
              <div
                class="nav1"
        ...
        <?php } ?>
          ...
          <a href="#creatinggame" class="ex4">
              ...
              <form action="gamescatalogueadmin.php" method="post">
                ...
                <p style="text-align:left; font-size: small; color: #868a8f;">Note: Square images look best.</p>
                
                <input name="imagelink" type="text" class="textbox" style="float:left; width: 100%;">
                <br><br>
                <p style="text-align: left">Game Title</p>
                
                <input name="gametitle" type="text" class="textbox" style="float:left; width: 100%;">
                <br><br>
                <p style="text-align: left">Rating</p>
                
                <input name="rating" type="text" class="textbox" style="float:left; width: 100%;">
                <br><br>
                <p style="text-align: left">Genre</p>
                <p style="text-align:left; font-size: small; color: #868a8f;">Note: Max 3 characters</p>
                <input name="genre" type="text" class="textbox" style="float:left; width: 100%;">
                <br><br><br>
                <input
                    name="creategame"
                    type="submit"
                    value="Create Game"
                    action="gamescatalogueadmin.php"
                    method="post"
